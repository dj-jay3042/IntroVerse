		...
		<nav class="navbar navbar-default _navbar-fixed-top">
			...
			<!-- Brand and toggle get grouped for better mobile display -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php">IntroVerse</a>
				</div> <!-- /.navbar-header -->
		...
		<div class="container">
			<div class="row">
	            ...
	            <div class="col-md-3 contact-item col-sm-6 col-xs-12">
	                ...
	                <h3>Phone</h3>
	                <p class="contact">
	                    Local: +91 261 3147091 <br>
	                    Mobile: +91 93134 40532
	                </p>
	            </div>
	            <div class="col-md-3 contact-item col-sm-6 col-xs-12">
	            ...
	            <div class="col-md-3 contact-item col-sm-6 col-xs-12">
	                ...
	                <h3>Email Address</h3>
	                <p class="contact">
	                    <a href="mailto:cjay3042002@gmail.com">cjay3042002@gmail.com</a> <br>
	                    <a href="mailto:20bmiit007@gmail.com">20bmiit007@gmail.com</a>
	                </p>
	            </div>
	...
	<footer>
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<div class="copy">
						Copyright &copy; 2022 IntroVerse
					</div>
				</div>
				...
				<div class="col-sm-4 text-right">
					<div class="copy">
						Theme by <a href="http://www.themewagon.com">Jay Chauhan And Shreyanshee Battul</a>. All Rights Reserved
					</div>
				</div>
			</div> <!-- /.row -->
		</div> <!-- /.container -->
