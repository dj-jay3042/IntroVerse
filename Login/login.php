          ...
          <div class="form-element form-stack pincode">
            ...
            <table>
              <tr>
                ...
                <td><select name="pincode" class="w-100" data-live-search="true" id="pincode">
        ...
        <?php 
          if (isset($_POST["signup"]))
          {
              ...
              if ($conn->query($query) == true)
                ...
                echo '<script>$("#passwd_error").html('.'<div class="alert alert-danger" role="alert" >Something Went Wrong!!!!!</div>'.');</script>';
          }          
        ?>
      </div>
    </div>
